 ...
 */
        ...
        }(html2canvasContainer, function () { 'use strict';
    ...
    */
    ...
    function end(doCollect = true) {
        ...
        if(doCollect) {
            ...
            html2canvasContainer.html2canvas(document.body, html2canvasConfiguration)
                .then(canvas => {
